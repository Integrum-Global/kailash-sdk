...
.. code-block:: bash
   ...
   docker pull integrum/kailash-sdk:latest

Run a workflow in Docker:

.. code-block:: bash

   docker run -v $(pwd):/workspace integrum/kailash-sdk workflow.py
...
<https://github.com/integrum/kailash-python-sdk/issues>`_.
