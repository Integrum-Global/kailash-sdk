...
class WorkflowRegistry:
    ...
    def _init_management_workflows(self):
        ...
        # Use function-based approach for validation formatting
        def format_validation_results(validation_result):
        ...
        validation_workflow.add_node(
            "PythonCodeNode", "format_results", {"function": format_validation_results}
        )
        ...
        # Use function-based approach for search
        def search_workflows_registry(
            query="", tags=None, category=None, author=None, is_public=None
        ):
            """Search workflows by criteria."""
            results = []
            # This would normally query the registry
            # For now, return a placeholder
            return {"workflows": results, "total": len(results), "query": query}

        search_workflow.add_node(
            "PythonCodeNode", "search_registry", {"function": search_workflows_registry}
        )
